...
Plugin URI: https://www.pickplugins.com/item/product-slider-display-any-post-type-in-carousel-slider/?ref=dashboard
...
class ProductSlider{
	...
	public function __construct(){
		...
		define('product_slider_wp_reviews', 'https://wordpress.org/plugins/product-slider/#reviews' );
		define('product_slider_pro_url','https://www.pickplugins.com/item/product-slider-display-any-post-type-in-carousel-slider/?ref=dashboard' );
		define('product_slider_demo_url', 'http://www.pickplugins.com/demo/product-slider/?ref=dashboard' );
		define('product_slider_conatct_url', 'https://pickplugins.com/contact/?ref=dashboard' );
		define('product_slider_qa_url', 'https://www.pickplugins.com/questions/?ref=dashboard' );
		define('product_slider_plugin_name', 'Product Slider' );
		define('product_slider_version', '1.0.2' );
