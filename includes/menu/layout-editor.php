...
if(empty($_POST['product_slider_hidden']))
	...
	{	
		if($_POST['product_slider_hidden'] == 'Y') {
			...
			//$product_slider_layout_content = stripslashes_deep($_POST['product_slider_layout_content']);			
			$product_slider_layout_content = get_option( 'product_slider_layout_content' );
			
			$product_slider_layout_content = array_merge($product_slider_layout_content, stripslashes_deep($_POST['product_slider_layout_content']));
			update_option('product_slider_layout_content', $product_slider_layout_content);
...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".__(product_slider_plugin_name.' - Layout Editor', 'product_slider')."</h2>";?>
							...
							<?php
                             ...
                             foreach($items as $item_key=>$item_info){
								 ...
								 if($item_key=='css'){
									...
									?>
	<br />
									<textarea autocorrect="off" autocapitalize="off" spellcheck="false"  style="width:50%" class="custom_css" item_id="<?php echo $items['key']; ?>" name="product_slider_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]"><?php echo $item_info; ?></textarea><br />
								...
								elseif($item_key=='char_limit'){
										?>
                                        	...
                                        	Character limit: <br />
											<input type="text"  name="product_slider_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]" value="<?php echo $items['char_limit']; ?>" /><br />
									...
									?>
										<input type="hidden"  name="product_slider_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]" value="<?php echo $item_info; ?>" />
									...
									if($item_key=='field_id'){
										?>
                                        	...
                                        	Meta Key: <br />
											<input type="text"  name="product_slider_layout_content[<?php echo $layout_content; ?>][<?php echo $i; ?>][<?php echo $item_key; ?>]" value="<?php echo $item_info; ?>" /><br />
